...
function resumirSelecoes(item: ReturnType<typeof useCarrinhoStore.getState>['itens'][number]) {
...
export default function Carrinho() {
  ...
  const { qtdItens, subtotal, desconto, total } = useCarrinhoTotais()
  ...
  async function handleAplicar() {
    ...
    const r = await validarCupom(codigoCupom)
    if (r.valido) {
