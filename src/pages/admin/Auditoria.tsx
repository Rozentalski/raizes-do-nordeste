...
export default function Auditoria() {
  ...
  return (
    <div className="mx-auto max-w-7xl space-y-5 px-6 py-6">
      ...
      {/* Filtros sticky */}
      <section className="sticky top-0 z-10 -mx-6 border-b border-border bg-background/95 px-6 py-3 backdrop-blur">
      ...
      >
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            <DialogTitle className="font-serif">Filtros avançados</DialogTitle>
            <DialogDescription>
