    ...
    <main className="min-h-screen bg-background">
      ...
      <article className="mx-auto max-w-2xl space-y-6 px-5 py-8 text-sm leading-relaxed text-foreground md:px-8">
        ...
        <section className="space-y-2">
          <h2 className="font-serif text-xl">1. Introdução</h2>
          <p>
            Esta Política descreve como a rede Raízes do Nordeste coleta, usa,
        ...
        <section className="space-y-2">
          <h2 className="font-serif text-xl">2. Dados que coletamos</h2>
          <p>
        ...
        <section className="space-y-2" id="tratamento">
          <h2 className="font-serif text-xl">3. Como usamos seus dados</h2>
          <ul className="ml-5 list-disc space-y-1">
            <li>Processar pedidos e pagamentos.</li>
            <li>Operar o programa de fidelidade Raízes.</li>
            <li>
        ...
        <section className="space-y-2">
          <h2 className="font-serif text-xl">4. Compartilhamento</h2>
          <p>
        ...
        <section className="space-y-2">
          <h2 className="font-serif text-xl">5. Seus direitos (LGPD Art. 18)</h2>
          <ul className="ml-5 list-disc space-y-1">
        ...
        <section className="space-y-2">
          <h2 className="font-serif text-xl">6. Retenção</h2>
          <p>
        ...
        <section className="space-y-2">
          <h2 className="font-serif text-xl">7. Cookies</h2>
          <p>
        ...
        <section className="space-y-2">
          <h2 className="font-serif text-xl">8. Segurança</h2>
          <p>
        ...
        <section className="space-y-2">
          <h2 className="font-serif text-xl">9. Encarregado pelo Tratamento (DPO)</h2>
          <p>
          ...
          <p className="rounded-md bg-muted p-3">
            ...
            <br />
            <strong>Endereço:</strong> Av. Conselheiro Aguiar, 1234 — Boa
            Viagem, Recife/PE
          </p>
        </section>

        <section className="space-y-2">
          <h2 className="font-serif text-xl">10. Atualizações desta política</h2>
          <p>
