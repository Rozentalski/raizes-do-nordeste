...
export default function EditarPerfil() {
  ...
  return (
    <main className="min-h-screen bg-background pb-12">
      <header className="sticky top-0 z-10 flex items-center gap-2 bg-background/85 px-3 py-3 backdrop-blur">
        <Button asChild variant="ghost" size="icon" aria-label="Voltar">
          <Link to="/conta">
            <ArrowLeft />
          </Link>
        </Button>
        <h1 className="font-serif text-lg text-foreground">Editar perfil</h1>
      </header>
