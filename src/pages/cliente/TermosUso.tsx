  ...
  return (
    <main className="min-h-screen bg-background">
      <header className="sticky top-0 z-10 flex items-center gap-2 border-b border-border bg-background/85 px-4 py-3 backdrop-blur">
        ...
        <h1 className="font-serif text-lg text-foreground">Termos de Uso</h1>
      </header>
      ...
      <article className="mx-auto max-w-2xl space-y-6 px-5 py-8 text-sm leading-relaxed text-foreground md:px-8">
        ...
        <section className="space-y-2">
          <h2 className="font-serif text-xl">1. Aceitação</h2>
          <p>
            Ao criar conta ou usar o aplicativo da rede Raízes do Nordeste, você
        ...
        <section className="space-y-2">
          <h2 className="font-serif text-xl">2. Cadastro</h2>
          <p>
        ...
        <section className="space-y-2">
          <h2 className="font-serif text-xl">3. Pedidos e pagamentos</h2>
          <p>
            ...
            (gateway externo) — a Raízes não armazena dados completos de cartão.
          </p>
        </section>

        <section className="space-y-2">
          <h2 className="font-serif text-xl">4. Cardápio e disponibilidade</h2>
          <p>
        ...
        <section className="space-y-2">
          <h2 className="font-serif text-xl">5. Programa de fidelidade Raízes</h2>
          <ul className="ml-5 list-disc space-y-1">
            ...
            <li>
              A Raízes pode rever o programa com aviso prévio de 30 dias. Pontos
        ...
        <section className="space-y-2">
          <h2 className="font-serif text-xl">6. Cupons e descontos</h2>
          <p>
        ...
        <section className="space-y-2">
          <h2 className="font-serif text-xl">7. Conduta esperada</h2>
          <p>
        ...
        <section className="space-y-2">
          <h2 className="font-serif text-xl">8. Limitação de responsabilidade</h2>
          <p>
            A Raízes se compromete a manter o serviço disponível, mas não pode
        ...
        <section className="space-y-2">
          <h2 className="font-serif text-xl">9. Encerramento de conta</h2>
          <p>
            Você pode excluir a conta a qualquer momento em "Privacidade e
            dados". A Raízes pode encerrar contas em caso de violação destes
            Termos, com aviso prévio sempre que possível.
          </p>
        </section>

        <section className="space-y-2">
          <h2 className="font-serif text-xl">10. Foro e legislação</h2>
          <p>
            Estes Termos são regidos pelas leis brasileiras. Conflitos serão
            resolvidos no foro da comarca de Recife/PE, salvo direitos de
