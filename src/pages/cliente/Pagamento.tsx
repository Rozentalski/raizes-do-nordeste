...
import { useCarrinhoStore, useCarrinhoTotais } from '@/stores/carrinho'
...
import type { DadosCartao, DadosPagamento } from '@/services/pagamento'
...
export default function Pagamento() {
  ...
  const criarPedido = useStorePedidos((s) => s.criarPedido)
...
function CabecalhoVoltar() {
  return (
    <header className="mb-4 flex items-center gap-2">
      ...
      <h1 className="font-serif text-2xl text-foreground">Pagamento</h1>
    </header>
  )
}
