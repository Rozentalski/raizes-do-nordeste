...
import { getProduto } from '@/services/cardapioService'
import {
  ROTULOS_ALERGENICO,
  ROTULOS_TAG,
  type Customizacao,
    ...
    <section className="pb-44 md:pb-32">
      <div className="relative aspect-[4/3] w-full overflow-hidden bg-muted md:aspect-[21/9]">
        ...
        <Button
          ...
          variant="ghost"
          size="icon"
          className="absolute left-3 top-3 size-11 rounded-full bg-card/85 text-foreground shadow-sm backdrop-blur hover:bg-card"
      ...
      <div className="-mt-6 rounded-t-3xl bg-background px-4 pt-6 md:px-8">
        <div className="flex items-start justify-between gap-3">
          ...
          <span className="whitespace-nowrap font-serif text-xl text-primary md:text-2xl">
      ...
      <div className="fixed bottom-16 left-0 right-0 z-20 border-t border-border bg-card/95 px-4 py-3 shadow-[0_-4px_12px_rgba(0,0,0,0.05)] backdrop-blur md:bottom-0">
        <div className="mx-auto flex w-full max-w-2xl flex-col gap-3">
          <div className="flex items-center justify-center gap-6">
            ...
            <span
              className="min-w-[2ch] text-center font-serif text-2xl text-foreground"
              aria-live="polite"
            >
              {quantidade}
            </span>
