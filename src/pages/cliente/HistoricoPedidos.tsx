...
export default function HistoricoPedidos() {
  ...
  // Persist do Zustand re-hidrata async — antes disso, o array vem vazio.
  // Esse estado é instantâneo após hidratar, mas mostra skeleton no primeiro tick.
      ...
      >
        ...
        <div className="min-w-0 flex-1">
          ...
          <p className="mt-0.5 text-xs text-muted-foreground">
            ...
            {totalItens === 1 ? '' : 's'} · Raízes — {pedido.unidadeNome}
          </p>
