...
import { distanciaKm, listarUnidades } from '@/services/unidadesService'
...
export default function SelecaoUnidade() {
  ...
  const visiveis = unidades
    ...
    .map((u) => ({
      unidade: u,
      distancia: coords ? distanciaKm(coords, u) : null,
    }))
    .sort((a, b) => {
  ...
  return (
    <main className="min-h-screen bg-background pb-12">
      <header className="sticky top-0 z-10 flex items-center justify-between bg-background/85 px-3 py-3 backdrop-blur">
            ...
            <DialogDescription asChild>
              <div className="space-y-2 text-left">
                ...
                <ul className="list-disc space-y-1 pl-5 text-sm">
                  <li>Sugerir a unidade Raízes mais próxima</li>
